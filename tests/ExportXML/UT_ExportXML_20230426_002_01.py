...
class XmlCreate:
    ...
    def create_xml_building_storey(self, storey):
        ...
        self.create_xml_transform(
            ...
            position=self.ifc_building_storey[storey["name"]]["position"],
            rotation=self.ifc_building_storey[storey["name"]]["rotation"],
            scale=self.ifc_building_storey[storey["name"]]["scale"]
        )
