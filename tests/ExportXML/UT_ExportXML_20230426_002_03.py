...
class XmlCreate:
    ...
    def add_properties(content):
        ...
        print(f"[add_properties] self: {content['self']}")
        ...
        bl_object["self"] = content["self"].__str__()
        print(f"[add_properties] bl_props_self: {bl_object['self']}")
